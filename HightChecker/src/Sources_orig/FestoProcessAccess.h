...
public:
    ...
    void setItemAtBeginning();
    void setItemAtMetallDetector();
    void setItemMetallic();
    void setItemAtHightSensor();
    void setItemAtEnd();

    void setItemNotAtMetallDetector();
    void setItemNotAtHightSensor();
    void setItemNotAtEnd();
};
