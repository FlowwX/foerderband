...
bool FestoProcessAccess::isItemAtMetalDetector(void) {
	unsigned char b = process->isBitSet(ITEM_AT_JUNCTION);
	return !(b); // active low
}
...
//------setter fuer Startwerte


void FestoProcessAccess::setButtonPressed(void) {
    process->setBitInProcessImage(BUTTON_START_PRESSED);
}

void FestoProcessAccess::setItemAtBeginning(void) {
    process->setBitInProcessImage(0);
}

void FestoProcessAccess::setItemAtEnd(void) {
    process->setBitInProcessImage(0);
}

void FestoProcessAccess::setItemNotAtEnd(void) {
    process->setBitInProcessImage(ITEM_AT_END);
}

void FestoProcessAccess::setItemAtMetallDetector(void) {
    process->setBitInProcessImage(0);
}

void FestoProcessAccess::setItemMetallic(void) {
    process->setBitInProcessImage(ITEM_IS_METTAL);
}

void FestoProcessAccess::setItemAtHightSensor(){
	process->setBitInProcessImage(0);
}

void FestoProcessAccess::setItemNotAtHightSensor(){
	process->setBitInProcessImage(ITEM_AT_HIGHT_SENSOR);
}

void FestoProcessAccess::setItemNotAtMetallDetector(){
	process->setBitInProcessImage(ITEM_AT_JUNCTION);
}
